        ...
        <div className="min-h-screen bg-(--dht-gray-light)">
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                <div className="bg-white rounded-lg shadow-sm p-8">
                    <h1 className="text-4xl font-bold text-(--dht-darker) mb-6">Cookie Policy</h1>
                    <p className="text-gray-600 mb-8">Last updated: May 6, 2026</p>

                    <div className="prose prose-lg max-w-none">
                        <section className="mb-8">
                            <h2 className="text-2xl font-bold text-(--dht-darker) mb-4">1. What Are Cookies</h2>
                        ...
                        <section className="mb-8">
                            <h2 className="text-2xl font-bold text-(--dht-darker) mb-4">2. How We Use Cookies</h2>
                        ...
                        <section className="mb-8">
                            <h2 className="text-2xl font-bold text-(--dht-darker) mb-4">3. Types of Cookies We Use</h2>
                            <div className="space-y-4">
                                <div>
                                    <h3 className="text-xl font-semibold text-(--dht-darker) mb-2">Session Cookies</h3>
                                ...
                                <div>
                                    <h3 className="text-xl font-semibold text-(--dht-darker) mb-2">Persistent Cookies</h3>
                                    <p className="text-gray-700">
                                ...
                                <div>
                                    <h3 className="text-xl font-semibold text-(--dht-darker) mb-2">Third-Party Cookies</h3>
                                    <p className="text-gray-700">
                        ...
                        <section className="mb-8">
                            <h2 className="text-2xl font-bold text-(--dht-darker) mb-4">4. Managing Your Cookie Preferences</h2>
                            <p className="text-gray-700 mb-4">
                        ...
                        <section className="mb-8">
                            <h2 className="text-2xl font-bold text-(--dht-darker) mb-4">5. Third-Party Cookies</h2>
                            <p className="text-gray-700 mb-4">
                        ...
                        <section className="mb-8">
                            <h2 className="text-2xl font-bold text-(--dht-darker) mb-4">6. Updates to This Policy</h2>
                            <p className="text-gray-700">
                        ...
                        <section className="mb-8">
                            <h2 className="text-2xl font-bold text-(--dht-darker) mb-4">7. Contact Us</h2>
                            <p className="text-gray-700 mb-4">
