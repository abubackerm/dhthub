            ...
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                <div className="bg-(--dht-navy-soft) rounded-lg shadow-sm p-8">
                    ...
                    <div className="prose prose-lg max-w-none">
                        ...
                        <section className="mb-8">
                            <h2 className="text-2xl font-bold text-white mb-4">3. Products & Services Information</h2>
                            <p className="text-gray-300 mb-4">
                        ...
                        <section className="mb-8">
                            <h2 className="text-2xl font-bold text-white mb-4">4. Quotations & Pricing</h2>
                            <p className="text-gray-300 mb-4">
                        ...
                        <section className="mb-8">
                            <h2 className="text-2xl font-bold text-white mb-4">5. Procurement & Supply</h2>
                            <p className="text-gray-300 mb-4">
                        ...
                        <section className="mb-8">
                            <h2 className="text-2xl font-bold text-white mb-4">10. Compliance & Regulations</h2>
                            <p className="text-gray-300">
