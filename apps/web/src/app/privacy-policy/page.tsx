        ...
        <div className="min-h-screen bg-(--dht-gray-light)">
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                <div className="bg-white rounded-lg shadow-sm p-8">
                    <h1 className="text-4xl font-bold text-(--dht-darker) mb-6">Privacy Policy</h1>
                    ...
                    <div className="prose prose-lg max-w-none">
                        ...
                        <section className="mb-8">
                            <h2 className="text-2xl font-bold text-(--dht-darker) mb-4">2. Information We Collect</h2>
                            <h3 className="text-xl font-semibold text-(--dht-darker) mb-3">a. Personal Information</h3>
                            ...
                            <h3 className="text-xl font-semibold text-(--dht-darker) mb-3 mt-6">b. Non-Personal Information</h3>
                            <p className="text-gray-700 mb-4">
                        ...
                        <section className="mb-8">
                            <h2 className="text-2xl font-bold text-(--dht-darker) mb-4">3. How We Use Your Information</h2>
                        ...
                        <section className="mb-8">
                            <h2 className="text-2xl font-bold text-(--dht-darker) mb-4">4. Information Sharing</h2>
                            <p className="text-gray-700 mb-4">
                        ...
                        <section className="mb-8">
                            <h2 className="text-2xl font-bold text-(--dht-darker) mb-4">5. Data Security</h2>
                            <p className="text-gray-700">
                        ...
                        <section className="mb-8">
                            <h2 className="text-2xl font-bold text-(--dht-darker) mb-4">6. Cookies & Tracking Technologies</h2>
                            <p className="text-gray-700">
                        ...
                        <section className="mb-8">
                            <h2 className="text-2xl font-bold text-(--dht-darker) mb-4">7. Third-Party Links</h2>
                            <p className="text-gray-700">
                        ...
                        <section className="mb-8">
                            <h2 className="text-2xl font-bold text-(--dht-darker) mb-4">8. Data Retention</h2>
                            <p className="text-gray-700">
                        ...
                        <section className="mb-8">
                            <h2 className="text-2xl font-bold text-(--dht-darker) mb-4">9. Your Rights</h2>
                            <p className="text-gray-700 mb-4">Depending on applicable laws, you may have the right to:</p>
                            <ul className="list-disc list-inside text-gray-700 space-y-2 ml-4">
                        ...
                        <section className="mb-8">
                            <h2 className="text-2xl font-bold text-(--dht-darker) mb-4">10. Compliance with Regulations</h2>
                            <p className="text-gray-700">
                        ...
                        <section className="mb-8">
                            <h2 className="text-2xl font-bold text-(--dht-darker) mb-4">11. Updates to This Policy</h2>
                            <p className="text-gray-700">
                        ...
                        <section className="mb-8">
                            <h2 className="text-2xl font-bold text-(--dht-darker) mb-4">12. Contact Information</h2>
                            <p className="text-gray-700 mb-4">
