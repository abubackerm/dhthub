            ...
            <div className="max-w-[1500px] mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex flex-col lg:flex-row items-start justify-between gap-12">
                    ...
                    <div className="lg:w-[20%] text-left pt-12">
                        <h2 className="text-[var(--dht-red)] font-bold text-xl uppercase tracking-[0.2em] mb-4">
                            OUR SERVICES
                        </h2>
                    ...
                    <div className="lg:w-[75%] relative">
                        ...
                        <div className="lg:absolute lg:right-0 lg:bottom-[-80px] w-full lg:w-[95%] bg-white border border-gray-100 shadow-[0_30px_60px_rgba(0,0,0,0.1)]">
