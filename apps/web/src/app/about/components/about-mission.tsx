...
export function AboutMission() {
  const { ref: missionRef, getAnimationClass: getMissionClass } = useScrollAnimation({
    threshold: 0.3,
    animationType: "fade-left",
  });

  const { ref: visionRef, getAnimationClass: getVisionClass } = useScrollAnimation({
    threshold: 0.3,
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 max-w-6xl mx-auto">
          ...
          <div
            ...
            className={`relative bg-white rounded-2xl p-8 shadow-xl hover:shadow-2xl transition-shadow duration-500 ${getMissionClass()}`}
          >
            {/* Icon */}
          ...
          <div
            ...
            className={`relative bg-(--dht-dark) text-white rounded-2xl p-8 shadow-xl hover:shadow-2xl transition-shadow duration-500 lg:-mt-8 ${getVisionClass()}`}
          >
            {/* Icon */}
            <div className="w-16 h-16 bg-(--dht-red) rounded-xl flex items-center justify-center mb-6">
        ...
        <div className="mt-16 grid grid-cols-2 md:grid-cols-4 gap-6 scroll-trigger">
          <div className="bg-white rounded-xl p-6 text-center hover:transform hover:-translate-y-2 transition-transform duration-300 shadow-lg scroll-trigger">
